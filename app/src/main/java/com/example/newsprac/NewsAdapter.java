...
import com.example.newsprac.News;
import com.example.newsprac.databinding.NewsBinding;
import com.project.newsapp.R;
import com.example.newsprac.AdapterItemClickListener;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.NewsViewHolder> {
    ...
    public void AdapterListNews(List<News> items, AdapterItemClickListener adapterItemClickListener) {
        this.items = items;
